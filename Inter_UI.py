...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.modelPath.setItemText(3, _translate("MainWindow", "upinterpolation_superresolution_gen1"))
        self.modelPath.setItemText(4, _translate("MainWindow", "Gen1-noNoiseNoBackgroundUpinterpolation2x"))
        self.modelPath.setItemText(5, _translate("MainWindow", "Gen1-noNoiseUpinterpolation2x"))
        self.modelPath.setItemText(6, _translate("MainWindow", "Gen1-noNoiseNoBackgroundSuperresolution"))
